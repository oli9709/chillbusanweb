...
const CustomTourBuilder = () => {
  ...
  const generateTourSummary = () => {
    ...
    const eveningName = eveningOptions.find(e => e.value === selectedEvening)?.name;
  ...
  }, [selectedLocations, selectedLunch, selectedServices, selectedEvening]);
